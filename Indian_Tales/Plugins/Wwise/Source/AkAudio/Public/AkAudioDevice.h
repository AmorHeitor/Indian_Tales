...
struct AKAUDIO_API FAkAudioDeviceDelegates
{
	...
	DECLARE_MULTICAST_DELEGATE_OneParam(FOnLoadSwitchValue, const FSoftObjectPath&);
	DECLARE_MULTICAST_DELEGATE_OneParam(FOnUnloadSwitchValue, const FSoftObjectPath&);
};
...
public:
	...
	*/
	...
	FAkAudioDeviceDelegates::FOnLoadSwitchValue OnLoadSwitchValue;
	FAkAudioDeviceDelegates::FOnUnloadSwitchValue OnUnloadSwitchValue;
