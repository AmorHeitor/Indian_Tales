...
=============================================================================*/
static_assert(AKCODECID_BANK == 0, "AKCODECID_BANK is not equal to 0, please change the value in the AkCodecId enum");
UENUM(BlueprintType)
enum class AkCodecId : uint8
{
	...
	WiiADPCM = AKCODECID_WIIADPCM,
	
	///< Standard PCM WAV file parser for Wwise Authoring
	PCMEX = AKCODECID_PCMEX,

	///< External Source (unknown encoding)
	ExternalSource = AKCODECID_EXTERNAL_SOURCE,
	...
	FilePackage = AKCODECID_FILE_PACKAGE,
	...
	ProfilerCapture = AKCODECID_PROFILERCAPTURE,

	///< Analysis file
	AnalysisFile = AKCODECID_ANALYSISFILE,
